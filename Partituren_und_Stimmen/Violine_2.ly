...
\score {
  ...
  \new Staff <<
    \new Voice {
      ...
      \clef "treble"
      \optionalTranspose { \transpose c c \violineIINotenKyrieMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \violineIINotenGloriaMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \violineIINotenCredoMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \violineIINotenSanctusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \violineIINotenBenedictusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \violineIINotenAgnusMozartOrgelsolomesse }
    }
  >>
