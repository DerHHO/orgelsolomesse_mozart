...
#(include-special-characters)
  ...
  \bookOutputName "Trompete_2"
  \header {
    instrument = "2. Trompete (C)"
  }
...
\score {
  ...
  \new Staff <<
    \new Voice {
      ...
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteIINotenKyrieMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteIINotenGloriaMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteIINotenCredoMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteIINotenSanctusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteIINotenBenedictusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteIINotenAgnusMozartOrgelsolomesse }
    }
  >>
