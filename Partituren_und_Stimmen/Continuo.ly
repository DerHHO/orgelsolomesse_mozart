...
\score {
  ...
  \new Staff <<
    \new Voice {
      ...
      \clef "bass"
      \optionalTranspose { \transpose c c \continuoNotenKyrieMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \continuoNotenGloriaMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \continuoNotenCredoMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \continuoNotenSanctusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \continuoNotenBenedictusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \continuoNotenAgnusMozartOrgelsolomesse }
    }
  >>
