...
#(include-special-characters)
  ...
  \bookOutputName "Trompete_1"
  \header {
    instrument = "1. Trompete (C)"
  }
...
\score {
  ...
  \new Staff <<
    \new Voice {
      ...
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteINotenKyrieMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteINotenGloriaMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteINotenCredoMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteINotenSanctusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteINotenBenedictusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteINotenAgnusMozartOrgelsolomesse }
    }
  >>
