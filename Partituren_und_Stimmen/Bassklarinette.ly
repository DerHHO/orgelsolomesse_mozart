...
#(include-special-characters)
  ...
  \bookOutputName "Bassklarinette"
  \header {
    instrument = "Bassklarinette (B)"
  }
  ...
  \score {
    ...
    \new Staff <<
      \new Voice {
        ...
        \clef "treble"
        \optionalTranspose { \transpose c d' \continuoNotenKyrieMozartOrgelsolomesse }
      }
    >>
  ...
  \score {
    ...
    \new Staff <<
      \new Voice {
        \compressFullBarRests
        \clef "treble"
        \optionalTranspose { \transpose c d' \continuoNotenGloriaMozartOrgelsolomesse }
      }
    >>
  ...
  \score {
    ...
    \new Staff <<
      \new Voice {
        \compressFullBarRests
        \clef "treble"
        \optionalTranspose { \transpose c d' \continuoNotenCredoMozartOrgelsolomesse }
      }
    >>
  ...
  \score {
    ...
    \new Staff <<
      \new Voice {
        \compressFullBarRests
        \clef "treble"
        \optionalTranspose { \transpose c d' \continuoNotenSanctusMozartOrgelsolomesse }
      }
    >>
  ...
  \score {
    ...
    \new Staff <<
      \new Voice {
        \compressFullBarRests
        \clef "treble"
        \optionalTranspose { \transpose c d' \continuoNotenBenedictusMozartOrgelsolomesse }
      }
    >>
  ...
  \score {
    ...
    \new Staff <<
      \new Voice {
        \compressFullBarRests
        \clef "treble"
        \optionalTranspose { \transpose c d' \continuoNotenAgnusMozartOrgelsolomesse }
      }
    >>
