...
\score {
  ...
  \new Staff <<
    \new Voice {
      ...
      \clef "bass"
      \optionalTranspose { \transpose c c \paukenNotenKyrieMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \paukenNotenGloriaMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \paukenNotenCredoMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \paukenNotenSanctusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \paukenNotenBenedictusMozartOrgelsolomesse }
    }
  >>
...
\score {
  ...
  \new Staff <<
    \new Voice {
      \compressFullBarRests
      \clef "bass"
      \optionalTranspose { \transpose c c \paukenNotenAgnusMozartOrgelsolomesse }
    }
  >>
