...
HWMarkup = \markup { \bold HW }
SWMarkup = \markup { \bold SW }
IIMarkup = \markup { \bold II }
POSMarkup = \markup { \bold POS }
PEDMarkup = \markup { \bold PED }
OrgelklammerMarkup = \markup { \vcenter { \bold \override #'(font-encoding . fetaBraces) \lookup #"brace50" } }
registrierungsPfeil = \markup {
  \combine
      \draw-line #'(0 . 3.5)
      \arrow-head #Y #DOWN ##f
}

keilMarkup = \markup { } %\markup { \hspace #0.6 \draw-line #'(0 . 1) }

pizzicatoMarkup = \markup { \italic pizz. }
arcoMarkup = \markup { \italic arco }